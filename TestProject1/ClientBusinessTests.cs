...
/// <summary>
/// Contains unit tests for the <see cref="ClientBusiness"/> class, verifying business logic for client management.
/// </summary>
public partial class ClientBusinessTests
{
    ...
    /// <summary>
    /// Creates an instance of <see cref="ClientBusiness"/> with mocked dependencies.
    /// </summary>
    /// <returns>A new <see cref="ClientBusiness"/> instance.</returns>
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.GetAsync"/> returns a queryable list of <see cref="ClientViewModel"/>.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.GetByIdAsync(long)"/> returns a <see cref="ClientViewModel"/> when the client exists.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.GetByIdAsync(long)"/> throws <see cref="KeyNotFoundException"/> when the client does not exist.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.CreateAsync(ClientCreateModel)"/> adds a client and extension when the name is unique.
    /// </summary>
    [Fact]
    public async Task CreateAsync_AddsClientAndExtension_WhenNameIsUnique()
    {
        ...
        _clientRepoMock.Setup(r => r.AddAsync(It.IsAny<Client>())).Returns((Task<Client>)Task.CompletedTask);
        _clientExtRepoMock.Setup(r => r.AddAsync(It.IsAny<ClientExtension>())).Returns((Task<ClientExtension>)Task.CompletedTask);
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.CreateAsync(ClientCreateModel)"/> throws <see cref="InvalidOperationException"/> when the client name already exists.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.UpdateAsync(ClientUpdateModel)"/> updates a client and extension when valid.
    /// </summary>
    [Fact]
    public async Task UpdateAsync_UpdatesClientAndExtension_WhenValid()
    {
        ...
        _unitOfWorkMock.Setup(u => u.ExecuteAsync(It.IsAny<Func<Task>>()))
            .Returns<Func<Task>>(f => f());
        _clientRepoMock.Setup(r => r.UpdateAsync(1, client)).Returns((Task.CompletedTask as Task<Client>)!);
        _clientExtRepoMock.Setup(r => r.UpdateAsync(2, clientExt)).Returns((Task.CompletedTask as Task<ClientExtension>)!);
        _unitOfWorkMock.Setup(u => u.SaveChangesAsync()).ReturnsAsync(1);
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.UpdateAsync(ClientUpdateModel)"/> throws <see cref="KeyNotFoundException"/> when the client is not found.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.UpdateAsync(ClientUpdateModel)"/> throws <see cref="InvalidOperationException"/> when the client name already exists.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.DeleteAsync(long)"/> updates the client when found.
    /// </summary>
    [Fact]
    public async Task DeleteAsync_UpdatesClient_WhenFound()
    {
        ...
        _clientRepoMock.Setup(r => r.GetByIdAsync(1)).ReturnsAsync(client);
        _clientRepoMock.Setup(r => r.UpdateAsync(1, client)).Returns((Task<Client>)Task.CompletedTask);
        _unitOfWorkMock.Setup(u => u.SaveChangesAsync()).ReturnsAsync(1);
    ...
    /// <summary>
    /// Tests that <see cref="ClientBusiness.DeleteAsync(long)"/> throws <see cref="KeyNotFoundException"/> when the client is not found.
    /// </summary>
    [Fact]
