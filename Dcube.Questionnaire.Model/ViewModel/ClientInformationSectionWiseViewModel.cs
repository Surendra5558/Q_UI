...
/// </summary>
public class ClientInformationSectionWiseViewModel : IBaseViewModel
{
    /// <summary>
    /// Gets or sets the status identifier for the client questionnaire section.
    /// </summary>
    public long ClientTemplateInfromationSectionStatusId { get; set; }

    /// <summary>
    /// Gets or sets the status name for the client questionnaire section.
    /// </summary>
    public string ClientTemplateInfromationSectionStatusName { get; set; } = null!;
    ...
    /// </summary>
    public string InformationSectionName { get; set; } = null!;


    /// <summary>
    /// Gets or sets the collection of questionnaire responses for this section.
    /// </summary>
    public List<InformationResponse> InformationResponses { get; set; } = [];
...
/// </summary>
public class InformationResponse : IBaseViewModel
{
    /// <summary>
