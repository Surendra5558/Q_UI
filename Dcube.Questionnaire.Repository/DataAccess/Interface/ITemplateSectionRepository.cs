...
/// <summary>
/// Repository interface for managing <see cref="Template"/> entities.
/// Inherits standard CRUD operations from <see cref="IRepository{TContext, TEntity}"/>.
/// </summary>
public interface ITemplateSectionRepository : IRepository<QuestionnaireDbContext, TemplateSection>
{
}