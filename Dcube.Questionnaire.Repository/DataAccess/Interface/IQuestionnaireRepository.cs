...
/// <summary>
/// Repository interface for managing <see cref="Questionnaire"/> entities.
/// Inherits standard CRUD operations from <see cref="IRepository{TContext, TEntity}"/>.
/// </summary>
public interface IQuestionnaireRepository : IRepository<QuestionnaireDbContext, Domain.Questionnaire>
{
}